...
hadoop jar $HADOOP_STREAMING_JAR_PATH \
            -file $JOB_DIR/mapper1.py -mapper $JOB_DIR/mapper1.py \
            -file $JOB_DIR/reducer1.py -reducer $JOB_DIR/reducer1.py \
...
hadoop jar $HADOOP_STREAMING_JAR_PATH \
        -file $JOB_DIR/mapper2.py -mapper $JOB_DIR/mapper2.py \
        -file $JOB_DIR/reducer2.py -reducer $JOB_DIR/reducer2.py \
