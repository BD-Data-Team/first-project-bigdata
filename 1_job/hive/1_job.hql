...
SELECT review_year, product_id, COUNT(*) as reviews_count
FROM reviews
...
SELECT top_10_products_for_year.review_year as review_year, top_10_products_for_year.product_id as product_id, reviews.text as text
FROM top_10_products_for_year, reviews
WHERE top_10_products_for_year.review_year = reviews.review_year AND top_10_products_for_year.product_id = reviews.product_id;
